...
export const CONTRACT_ADDRESS =
  "CBLG46P7IOC6W7FBQD4KGXLU7P7CYF7LTLZE57QFO3PFADSJ6JUSBKNY";
 ...
 * Calls: init()
 */
export async function initLottery(caller: string) {
...
/**
 * Pick a winner (requires auth - typically admin).
 * Calls: pick_winner() -> Address
 */
export async function pickWinner(caller: string) {
  return callContract("pick_winner", [], caller, true);
}
